  ...
  return (
    <section id="contato" className="bg-slate-950 px-4 py-20 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl rounded-lg border border-white/10 bg-white/[0.06] p-8 text-center shadow-2xl shadow-black/20 sm:p-12">
        ...
        <a className="mt-8 inline-flex items-center justify-center gap-2 rounded-md bg-emerald-500 px-6 py-3 font-bold text-white transition hover:-translate-y-1 hover:bg-emerald-400" href={content.whatsappUrl} rel="noreferrer" target="_blank">
